...
class EncaissementController extends Controller
{
    ...
    public function encaissements()
    {
        ...
        return view('admin.mouvement.encaissement')->with(
            [
                'data' => $data,
    ...
    public function decaissement()
    {
        ...
        $decaissements = Mouvement::getListe($annee_id, null, $role, null, TypeMouvement::DECAISSEMENTS );




        // Totaux paiements
        $total = Mouvement::getTotal($annee_id, null, $role, null, TypeMouvement::DECAISSEMENTS);
        $total_mois = Mouvement::getTotal($annee_id, null,  $role, null, TypeMouvement::DECAISSEMENTS, StatutPaiement::ENCAISSE,$debutmois, $finmois);
        $total_semaine = Mouvement::getTotal($annee_id, null,  $role, null, TypeMouvement::DECAISSEMENTS,StatutPaiement::ENCAISSE,  $debutsemaine, $finsemaine);
        $total_jour = Mouvement::getTotal($annee_id, null,  $role, null, TypeMouvement::DECAISSEMENTS, StatutPaiement::ENCAISSE, $aujourdhui);
        ...
        foreach($decaissements as  $decaissement ){
            ...
            $data[]  = array(
                ...
                "id" => $decaissement->id,
                "reference" => $decaissement->depense->reference == null ? ' ' : $decaissement->paiement->reference,
                ...
                "responsable" => $decaissement->caisse_id == null ? ' ' : $decaissement->caisse->responsable->nom.' '.$decaissement->caisse->responsable->prenom,
        ...
        return view('admin.mouvement.decaissement')->with(
            [
                'data' => $data,
    ...
    public function mouvements()
    {
        ...
        $mouvements = Mouvement::getListe($annee_id, null, $role );




        // Totaux paiements
        $total = Mouvement::getTotal($annee_id, null, $role);
        $total_mois = Mouvement::getTotal($annee_id, null,  $role,null, null, $debutmois, $finmois);
        $total_semaine = Mouvement::getTotal($annee_id, null,  $role, null, null,  $debutsemaine, $finsemaine);
        $total_jour = Mouvement::getTotal($annee_id, null,  $role, null, null, $aujourdhui);
        ...
        foreach($mouvements as  $mouvement ){
            ...
            $data[]  = array(
                ...
                "date_operation" => $mouvement->created_at == null ? ' ' : $mouvement->created_at,
                ...
                "responsable" => $mouvement->caisse_id == null ? ' ' : $mouvement->caisse->responsable->nom.' '.$decaissement->caisse->responsable->prenom,
    ...
    public function pdf($id)
    {
        ...
        $souscription_scolarite = Souscription::getPrix($inscription->niveau_id,$annee_id, $inscription->id, null, TypePaiement::FRAIS_SCOLARITE );
        ...
        $montant_scolarite =$souscription_scolarite->montant_annuel_prevu;
