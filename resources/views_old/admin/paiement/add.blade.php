                ...
                success: function (data) {
                    ...
                    for (let i = 0; i < frais.length; i++) {
                        ...
                        output += `
                            ...
                            <td data-id="${frais[i].id}">${frais[i].libelle}</td>
...
<input type="number" class="form-control montant_a_payer"  data-id="${frais[i].id}">
        ...
        function validerPaiement() {
            ...
            $('#liste_frais  tr').each(function () {
                ...
                var detail = {
                    ...
                    souscription_id: $(this).find("td:eq(0)").attr('data-id'),
                    frais_ecole: $(this).find("td:eq(0)").text(),
                    montant: parseFloat($(this).find(".montant_a_payer").val()) ,
                ...
                mt += parseFloat($(this).find(".montant_a_payer").val());
            ...
            if (allValid) {
                ...
                if (liste_details.length) {
                    ...
                    for (var i = 0; i < liste_details.length; i++) {
                        formData.append('ligne_details[' + i + '][souscription_id]', liste_details[i].souscription_id);
