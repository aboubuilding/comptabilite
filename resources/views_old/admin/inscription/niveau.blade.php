...
@section('title')
    ...
    Comptabilité | Inscriptions par niveau
                                    ...
                                    @foreach( $data as $niveau  )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <span class="badge badge-rounded badge-success">{{ $niveau ['total_eleves'] }} </span>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge badge-rounded badge-success">{{ $niveau ['total_garcons'] }} </span>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge badge-rounded badge-success">{{ $niveau ['total_filles'] }} </span>
                                                ...
                                                <div class="d-flex">
                                                    <div class="dropdown custom-dropdown ">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item " href="" data-id="{{$niveau['id']}}">Exporter la liste des eleves en PDF  </a>
