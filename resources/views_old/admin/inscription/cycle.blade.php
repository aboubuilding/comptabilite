...
@section('title')
    ...
    Comptabilité | Inscriptions par cycle
                                    ...
                                    @foreach( $data as $cycle  )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <span class="badge badge-rounded badge-success">{{ $cycle ['total_eleves'] }} </span>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge badge-rounded badge-success">{{ $cycle ['total_garcons'] }} </span>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge badge-rounded badge-success">{{ $cycle ['total_filles'] }} </span>
                                                ...
                                                <div class="d-flex">
                                                    <div class="dropdown custom-dropdown ">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item " href="" data-id="{{$cycle['id']}}">Exporter la liste des eleves en PDF  </a>
