...
@section('title')
    ...
    Comptabilité | Inscriptions par classe
                                    ...
                                    @foreach( $data as $classe  )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <span class="badge badge-rounded badge-success">{{ $classe ['total_eleves'] }} </span>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge badge-rounded badge-success">{{ $classe ['total_garcons'] }} </span>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge badge-rounded badge-success">{{ $classe ['total_filles'] }} </span>
                                                ...
                                                <div class="d-flex">
                                                    <div class="dropdown custom-dropdown ">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item " href="" data-id="{{$classe['id']}}">Exporter la liste des eleves en PDF  </a>
                                                            <a class="dropdown-item" href="">Exporter la liste des eleves en Excel </a>
                                                            <a class="dropdown-item" href="">Fiche financière </a>
