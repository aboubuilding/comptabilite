                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#encaissement"><i
                                        ...
                                        <span class="badge badge-rounded badge-success">{{ $total_encaissements }} </span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#decaissement"><i
                                        ...
                                        <span class="badge badge-rounded badge-success">{{ $total_decaissements }} </span>
                                    </a>
                                </li>
                                                                ...
                                                                @foreach ($data_encaissements as $encaissement)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <span
                                                                                class="badge badge-rounded badge-success">{{ $encaissement['montant'] }}
                                                                            </span>
