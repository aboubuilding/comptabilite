            ...
            <div class="card">
                ...
                <div class="default-tab">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#frais"><i class="la la-user me-2"></i> Scolarité </a>
                        </li>
...
<input type="number" class="form-control montant_a_payer"  data-id="${frais[i].type_paiement}">
    ...
    $('#list_produit  tr').each(function () {
        ...
        montant_produits += montant_ligne_produit;
            ...
            total = total_detail+ montant_cantine + montant_produits + montant_livre + montant_bus;
    ...
    $('#list_produit  tr').each(function () {
        ...
        list_produit.push(detail_produit);
            ...
            if (allValid) {
                ...
                // Ajout des données de  scolarite     a formData
